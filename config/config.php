...
# What is the name of this app?
	define('APP_NAME', 'Project 4');  

# When email is sent out from the server, where should it come from?
# Ideally, this should match the domain name
	define('APP_EMAIL', 'imjoewebb@gmail.com'); 
...
*/ 	
	define('SYSTEM_EMAIL', 'imjoewebb@gmail.com'); 

# Default DB name for this app
	define('DB_NAME', "imjoeweb_p4_imjoewebb_biz"); 
...
# For extra security, you might want to set different salts than what the core uses
	define('PASSWORD_SALT', 'rUsCcH!UZx6iQBzZiP)5cfJQtU6nR87u0FlLEsrv');
	define('TOKEN_SALT',    'mUjd%YS(URXBeR&NYL@YlyzHsfo!%!CtrGSltbX7');
